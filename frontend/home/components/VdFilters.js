      ...
      <div class="mb-1 d-flex flex-column gap-2">
        ...
        <div class="d-flex align-items-center justify-content-center" style="gap:0.3rem;">
          ...
          <button type="button" class="sort-btn" data-sort="default"
            style="display:flex; align-items:center; justify-content:center; background:#141414; border:1px solid #2a2a2a; color:#aaa; border-radius:999px; width:52px; height:26px; font-size:0.7rem; cursor:pointer; transition:all 0.2s ease;">
          ...
          <button type="button" class="sort-btn" data-sort="rating_desc"
            style="display:flex; align-items:center; justify-content:center; gap:0.1rem; background:#141414; border:1px solid #2a2a2a; color:#aaa; border-radius:999px; padding:0 1.3rem; height:26px; font-size:0.7rem; cursor:pointer; transition:all 0.2s ease;">
